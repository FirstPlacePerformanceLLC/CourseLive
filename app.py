...
<style>
  * { box-sizing: border-box; }
  ...
  .hold.standby { padding: 40px 6px 46px; }
  .standbylogo { width: 78%; max-width: 300px; height: auto; display: block; margin: 0 auto 20px; }
...
function renderHoldScreen(){
  ...
  el("sub").textContent = "";
  el("body").innerHTML =
    '<div class="hold standby">' +
    '<img class="standbylogo" src="/brand/logo_full.png" alt="Dale Carnegie Nevada">' +
...
BRAND_LOGO_FULL_B64 = ""
...
@app.route("/brand/logo_full.png")
def brand_logo_full():
    return Response(base64.b64decode(BRAND_LOGO_FULL_B64), mimetype="image/png")
